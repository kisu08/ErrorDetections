function searchDataE2023() {
  ...
  if (!sheetB) {
    Logger.log('確認2023(日経E)が見つかりません: ' + sheetBName);
    SpreadsheetApp.getUi().alert('確認2023(日経E)が見つかりません: ' + sheetBName);
    return;
  }
  ...
  var startRowB = 7; // 確認2023(日経E)にデータを反映させる開始行
